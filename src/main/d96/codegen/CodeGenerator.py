...
class CodeGenerator(Utils):
    ...
    def init(self):
        return [
            ...
            Symbol(
                "putInt", MType([IntType()], VoidType()), CName(self.libName)
            ),
            Symbol(
                "putIntLn", MType([IntType()], VoidType()), CName(self.libName)
            )
        ]
...
class CodeGenVisitor(BaseVisitor, Utils):
    ...
    def visitProgram(self, ast, c):
        ...
        self.genMETHOD(
            FuncDecl(Id("<init>"), list(), None, Block(list(), list())), c,
            Frame("<init>", VoidType)
        )
    ...
    def genMETHOD(self, consdecl, o, frame):
        ...
        isMain = consdecl.name.name == "main" and len(
            consdecl.param
        ) == 0 and type(consdecl.returnType) is VoidType
    ...
    def visitFuncDecl(self, ast, o):
        ...
        return SubBody(
            None, [
                Symbol(
                    ast.name, MType(list(), ast.returnType),
