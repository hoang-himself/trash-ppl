...
class Emitter():
    ...
    def getJVMType(self, inType):
        ...
        if typeIn is IntType:
            ...
            return "(" + "".join(
                list(map(lambda x: self.getJVMType(x), inType.partype))
    ...
    *    @param typ the type of the constant
    ...
    def emitALOAD(self, in_, frame):
        ...
        elif type(in_) is cgen.ArrayPointerType or type(
            in_
        ) is cgen.ClassType or type(in_) is StringType:
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitREADVAR(self, name, inType, index, frame):
        ...
        elif type(inType) is cgen.ArrayPointerType or type(
            inType
        ) is cgen.ClassType or type(inType) is StringType:
