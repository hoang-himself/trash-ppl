...
class JasminCode(MachineCode):
    ...
    def emitIFACMPEQ(self, label):
        #label: Int
        return JasminCode.INDENT + "if_acmpeq Label" + str(
            label
        ) + JasminCode.END

    def emitIFACMPNE(self, label):
        #label: Int
        return JasminCode.INDENT + "if_acmpne Label" + str(
            label
        ) + JasminCode.END

    def emitIFICMPEQ(self, label):
        #label: Int
        return JasminCode.INDENT + "if_icmpeq Label" + str(
            label
        ) + JasminCode.END

    def emitIFICMPNE(self, label):
        #label: Int
        return JasminCode.INDENT + "if_icmpne Label" + str(
            label
        ) + JasminCode.END

    def emitIFICMPLT(self, label):
        #label: Int
        return JasminCode.INDENT + "if_icmplt Label" + str(
            label
        ) + JasminCode.END

    def emitIFICMPLE(self, label):
        #label: Int
        return JasminCode.INDENT + "if_icmple Label" + str(
            label
        ) + JasminCode.END

    def emitIFICMPGT(self, label):
        #label: Int
        return JasminCode.INDENT + "if_icmpgt Label" + str(
            label
        ) + JasminCode.END

    def emitIFICMPGE(self, label):
        #label: Int
        return JasminCode.INDENT + "if_icmpge Label" + str(
            label
        ) + JasminCode.END
    ...
    def emitVAR(self, in_, varName, inType, fromLabel, toLabel):
        ...
        return ".var " + str(
            in_
        ) + " is " + varName + " " + inType + " from Label" + str(
            fromLabel
        ) + " to Label" + str(toLabel) + JasminCode.END
